...
app.post('/cart/delete/:id', (req, res) => {
  ...
  if (cart && cart.item[itemId]) {
    const itemPrice = cart.item[itemId].item.price * cart.item[itemId].qty;
...
// Define a route for handling POST requests to /contact
app.post('/contact', (req, res) => {
  // Create a new Contact object based on the request body
